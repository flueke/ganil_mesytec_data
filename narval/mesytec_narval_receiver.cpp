...
void mesytec_mfm_converter::operator()(mesytec::event &event, mesytec::experimental_setup &)
{
   ...
   *((uint16_t*)(&mfmevent[8])) = event.get_tgv_ts_lo();
   *((uint16_t*)(&mfmevent[10])) = event.get_tgv_ts_mid();
   *((uint16_t*)(&mfmevent[12])) = event.get_tgv_ts_hi();
   ...
   *((uint32_t*)(&mfmevent[14])) = event.get_event_counter();
